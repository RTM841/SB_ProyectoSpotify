...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/canciones", "/api/canciones/{id}").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/canciones").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/canciones/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/canciones/{id}").hasRole("ADMIN")
